...
public final class ActivityUserGuideBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textViewUserGuide;

  private ActivityUserGuideBinding(@NonNull ScrollView rootView,
      @NonNull TextView textViewUserGuide) {
    this.rootView = rootView;
    this.textViewUserGuide = textViewUserGuide;
  }
  ...
  public static ActivityUserGuideBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.textViewUserGuide;
      TextView textViewUserGuide = ViewBindings.findChildViewById(rootView, id);
      if (textViewUserGuide == null) {
        break missingId;
      }

      return new ActivityUserGuideBinding((ScrollView) rootView, textViewUserGuide);
    }
